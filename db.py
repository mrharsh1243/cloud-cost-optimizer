...
class RDSInstance(Base):
    ...
    id = Column(Integer, primary_key=True)
    db_instance_identifier = Column(String)
    db_instance_status = Column(String)
    db_instance_class = Column(String)
...
class RDSSnapshot(Base):
    ...
    id = Column(Integer, primary_key=True)
    db_snapshot_identifier = Column(String)
    db_instance_identifier = Column(String)
    snapshot_create_time = Column(String)
    region = Column(String)
    last_seen = Column(String)
